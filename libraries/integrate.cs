...
public static class integrate {
    ...
    double f2=Double.NaN, double f3=Double.NaN) {
        ...
        /* note: Dmitri provided the following expression
         * as a potentially better way of calculating the integral;
         * we will use the typical method for now but leave
         * the code below for future inspection
        return quad(t => f(a + (b - a)*(3*t*t - 2*t*t*t))*(b - a)*6*(t - t*t),
            0, 1, delta, eps); */
    } // clenshaw_curtis
} // integrate
